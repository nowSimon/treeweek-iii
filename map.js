...
(async function () {
  ...
  const P = [
    ...
    { sec: '#fire-scene', zone: 'firelit', layer: 'near', sym: 'fir-2', x: 88, b: 0, w: 210, wm: 130, flip: true },
    { sec: '#fire-scene', zone: 'firelit', layer: 'near', sym: 'fir-3', x: 8, b: 2, w: 90, wm: 60 },
    { sec: '#fire-scene', zone: 'firelit', layer: 'near', sym: 'log-bench', x: 16, b: 2, w: 140, wm: 90 },
    { sec: '#fire-scene', zone: 'firelit', layer: 'near', sym: 'human-sit', x: 20, b: 5, w: 48, wm: 32 },
